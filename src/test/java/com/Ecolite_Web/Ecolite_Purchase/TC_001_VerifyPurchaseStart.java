...
public class TC_001_VerifyPurchaseStart extends TestBase {

	public static final Logger log = Logger.getLogger(TC_001_VerifyPurchaseStart.class.getName());
	...
	public void VerifyPurchaseStart() throws InterruptedException{
		...
		db.StartPurchase("Chethan pharmacy", "500", "0");
		CartPage cartpage = new CartPage();
		try {
			String ActualHeaderTitle = cartpage.getHeaderTitle();
			String ExpectedHeaderTitle = "Purchase" ;
			Assert.assertEquals(ActualHeaderTitle, ExpectedHeaderTitle);
			log.info("===== TC_001_VerifyPurchaseStart Finished =====");
		} catch (Exception e) {
			// TODO Auto-generated catch block
			e.printStackTrace();
			log.info("===== TC_001_VerifyPurchaseStart Skipped =====");
		}
	}
}
